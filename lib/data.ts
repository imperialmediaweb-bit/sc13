...
export const surse = [
  ...
  { url: "https://www.facebook.com/PrimaTVRomania/videos/27699584519670999/", text: "Prima TV — VIDEO: Revoltă la o școală gimnazială din Botoșani; zeci de părinți și elevi au protestat" },
  { url: "https://www.botosaneanul.ro/tipete-la-primarie-parintii-primiti-de-viceprimar-vreti-sa-tipati-asta-dorim-nu-povesti", text: "Botoșăneanul — VIDEO: Țipete la Primărie, părinții primiți de viceprimar" },
  { url: "https://www.botosaneanul.ro/tensiuni-la-primarie-din-cauza-intarzierilor-de-la-scoala-13-viceprimarul-intarzierile-au-fost-provocate-de-blocajele-la-plati", text: "Botoșăneanul — Tensiuni la Primărie; viceprimarul: întârzierile, provocate de blocajele la plăți" },
