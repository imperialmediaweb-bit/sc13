...
// Network-first pentru navigare, cu fallback pe cache (offline).
...
self.addEventListener("push", (event) => {
  let data = { title: "Școala 13 — actualizare", body: "Este o actualizare nouă pe pagina de monitorizare.", url: "/#actualizari" };
  try {
